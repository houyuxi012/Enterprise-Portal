                    ...
                    try:
                        async with db.begin_nested():
                            ...
                            if org.dn:
                                ...
                                dn_to_dept_id[org.dn] = dept.id
                            synced_org_count += 1
                    except Exception as org_exc:
                        logger.warning("Auto sync org upsert failed: %s %s", org.external_id, org_exc)
                        
                for org in orgs:
                    if org.parent_external_id and org.external_id in org_mapping_name:
                        child_id = dn_to_dept_id.get(org.dn) if org.dn else None
                        parent_id = dn_to_dept_id.get(org.parent_external_id)
