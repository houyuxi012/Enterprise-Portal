...
from modules.iam.services.identity.providers.base import (
    IdentityAuthResult,
...
class LdapIdentityProvider(IdentityProvider):
    ...
    def _resolve_avatar(cls, entry: Any, attr_name: str) -> bytes | None:
        ...
        import logging
        from modules.iam.services.identity.sync_errors import MAX_AVATAR_BYTES, ALLOWED_AVATAR_MIMES, SYNC_AVATAR_SIZE_EXCEEDED, SYNC_AVATAR_INVALID_FORMAT
