...
async def send_email_otp(to_email: str, username: str, db: AsyncSession) -> str:
    ...
    msg["From"] = cfg["sender"]
    msg["To"] = to_email
    msg["Subject"] = "登录验证码 - Enterprise Portal"
    ...
    try:
        ...
        logger.info(f"Email OTP sent to {to_email} for user {username}")
