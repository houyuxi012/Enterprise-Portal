...
async def delete_user(
    ...
    await db.execute(sa_delete(models.UserPasswordHistory).where(models.UserPasswordHistory.user_id == user_id))
    await db.execute(sa_delete(models.AnnouncementRead).where(models.AnnouncementRead.user_id == user_id))
